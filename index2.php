	...
	<body>
		<div class="container">
			...
			<div class="codrops-top clearfix">
				<a class="codrops-icon codrops-icon-prev" href=""><span>Inicio</span></a>
			...
			<header class="codrops-header">
				...
				<nav class="codrops-demos">
					<a href="index.php">Buscamos A....</a>
					<a class="current-demo" href="index2.php">Encontramos A....</a>
				</nav>
			</header>
			...
			<div class="content">
				...
				{?>
					...
					<div style="height:350px; overflow: visible; width: 100%; max-height: 100%;">
						...
						<figcaption>
							<h2 style='font-size: 20px;'><?php echo $row->nombre_encontrado ?></h2>
							<p>
							<?php 
								if ($row->estado_persona == "Busqueda") 
								{?>
								<a href="interfaz/verEncontrado.php?setCod=<?php echo $row->cod_encontrado ?>"><i class="fa fa-fw fa-share"></i></a>
								<a href="interfaz/regMensajeEncontrado.php?setCod=<?php echo $row->cod_encontrado ?>"><i class="fa fa-fw fa-envelope-o"></i></a>
								...
								{
								?>
									<h3 style="background: deepskyblue; color: black;">Persona Localizada</h3>
								<?php
								}
							?>
