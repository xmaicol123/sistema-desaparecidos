	...
	<body style="background: #2f3238; color: white;">
		...
		<div class="contenido"><!-- /container -->
			...
			<div class="container" style="height: auto;">
				<div class="row">
					<h2 class="text-center">Reportes De Personas Desaparecidas</h2>
					<div class="col-md-3">
					</div>
					<div class="col-md-6">
					<?php 
					...
					$reg = $obj->mostrarMensaje($_SESSION['cod_usuario'],$_GET['setCodDesaparecido']);
					...
					<div style="border: 2px solid black; background: white; color: black; margin: 10px; padding: 15px;">
						...
						<div class="form-group">
							<h4>2.- ¿Donde Lo Vieron?</h4>
							<h5>R.- <?php echo $row->mensaje_2 ?></h5>
						</div>
						<div class="form-group">
							<h4>3.- ¿Cuando Lo Vieron?</h4>
