		...
		<div class="contenido"><!-- /container -->
			...
			<header class="codrops-header">
				...
				<nav class="codrops-demos">
					<a href="consultaSistema.php">Buscamos A....</a>
					<a class="current-demo" href="consultaSistema2.php">Encontramos A....</a>
				</nav>
			</header>
			</div>
		</div><!-- /container -->
			...
			$obj = new Encontrado();
			$reg = $obj->consultaEncontrado($_SESSION['cod_usuario']);
