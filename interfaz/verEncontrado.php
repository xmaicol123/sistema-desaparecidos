...
<html lang="en" class="no-js">
	<head>
		...
		<!--ESTO ES PARA EL ENVIO DE DATOS POR FACEBOOK-->
		<title>¿Has Visto A...? <?php echo $row->nombre_desaparecido?></title>
		<meta property="og:locale" content="es_ES"/>
		<meta property="og:url" content="<?php echo "http://" . $host . $url;?>" />
		<meta property="og:title" content="¿Has Visto A...? <?php echo $row->nombre_encontrado?>" />
		<meta property="og:image" content="<?php echo $facebook_imagen; ?>" />
		<!--ESTO ES PARA EL ENVIO DE DATOS POR FACEBOOK-->
	...
	<body style="background: #2f3238; color: white;">
		...
		<?php 
			...
			<div class="container" style="height: auto;">
				<div class="row">
					<h2 class="text-center bg-primary"><strong>¡AYUDANOS A BUSCAR A SUS FAMILIARES!</strong></h2>
					...
					<div class="col-md-1">
						<a href="regMensajeEncontrado.php?setCod=<?php echo $_GET['setCod'] ?>"><img src="../img/mensaje.png" class="" width="50" style="margin: 15px;"></a>
