		...
		<div class="contenido"><!-- /container -->
			...
			<header class="codrops-header">
				...
				<nav class="codrops-demos">
					<a class="current-demo" href="consultaSistema.php">Buscamos A....</a>
					<a href="consultaSistema2.php">Encontramos A....</a>
				</nav>
			</header>
			</div>
		</div><!-- /container -->
			...
			$reg = $obj->consultaDesaparecido($_SESSION['cod_usuario']);
