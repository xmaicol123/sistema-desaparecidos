...
<html lang="en" class="no-js">
	...
	<body style="background: #2f3238; color: white;">
		...
		<?php 
			...
			{?>
			<form method="POST" action="regMensajeDesaparecido.php">
			<div class="container">
				<div class="row">
					<h2 class="text-center">Reporte De Persona Desaparecida</h2>
					<div class="col-md-3">
					
					</div>
					<div class="col-md-6">
						<input type="text" name="txt_cod_desaparecido" value="<?php echo $_GET['setCod'] ?>" hidden>
						<div class="form-group">
							<h4 for="">¿A Quien Viste?</h4>
							<input type="text" class="form-control text-capitalize" name="txt_mensaje1" required="" value="<?php echo $row->nombre_desaparecido ?>">
						</div>
						<div class="form-group">
							<h4 for="">¿Donde Lo Viste?</h4>
							<input type="text" class="form-control" name="txt_mensaje2" required="">
						</div>
						<div class="form-group">
							<h4 for="">¿Cuando Lo Viste?</h4>
							<input type="text" class="form-control" name="txt_mensaje3" required="">
						</div>
						<div class="form-group">
							<h4 for="">Escribe una descripción lo más detallada posible del lugar y fecha de donde fue vista la persona.</h4>
		...
		<!--CODIGO PHP-->
		<?php 
		include_once('../php/PhpregMensajeDesaparecido.php');
		function guardar()
		{
			if (($_POST['txt_mensaje1']) && ($_POST['txt_mensaje2']) ) {
				$obj = new MensajeDesaparecido();
				$obj->setCodDesaparecido($_POST['txt_cod_desaparecido']);
